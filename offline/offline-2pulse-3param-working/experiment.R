setwd("~/RPAI/offline/offline-2pulse-3param-working")
...
train_idx=1:90
adapt_idx=0 + max(train_idx)
nonadapt_idx=1:50 + max(adapt_idx)
test_idx = nonadapt_idx
...
print(table(predicted.best, optim.acts[test_idx]))
