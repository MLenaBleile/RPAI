...
colors = c("red","blue","orange","purple")
plot(density(delta15-deltamodel), xlab="fixed personalization loss - agent personalization loss",type="n",xlim=c(-.4,.85), main="2 pulse performance", col="red", ylim=c(0,60))
