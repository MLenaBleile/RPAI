...
adj.val=2
plot(density(-agent.outcome.vec+ref.outcome.mat[,1]), col="red", xlab="final ltv reference-final ltv agent", adjust=adj.val,main="3 pulse performance", xlim=c(-.7,.7), ylim=c(0,15))
