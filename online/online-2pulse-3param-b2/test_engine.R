...
plot(density(ref.outcome.mat[,"random"]-all_test_data[, total_time,'ltv'],adjust=adj),xlim=c(-.1,.2),main="2 pulse performance", type="n", xlab="ltv reference-ltv agent")
