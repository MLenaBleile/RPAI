###this is the version of the nlm optimization routine that works
##do NOT make adjustments to this without first making a copy!!!
##24 June 2022

setwd("C:/Users/s198663/Documents/RPAI/online/online-2pulse-nlm-best")
...
true.param.gen[,'m'] = c(.9,.5,.1,.216,.5)
true.param.gen[,'var'] =c(.000001,0,0.0,0.0,1)
