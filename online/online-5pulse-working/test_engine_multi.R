...
par(mfrow=c(2,2))
adj.val=1
plot(density(-agent.outcome.vec[1:test_num]+ref.outcome.mat[1:test_num,1], adjust=adj.val), col="red", xlab="final ltv reference-final ltv agent",main="5 pulse performance")
